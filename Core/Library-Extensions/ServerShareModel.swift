...
/**
 *  Provides support for ServerShare library.
 */
struct ServerShareModelFile: ModelFile, DefaultModelFileComponent {
    ...
    // MARK: - Customised methods for ServerShare
    // MARK: - Initialisers
